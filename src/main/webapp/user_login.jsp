	...
	<section
		...
		<div class="container">
			<form class="row g-3 border rounded needs-validation pt-3 px-5 pb-5"
				novalidate method="post" action="UserLogin">
				...
				<div class="col-md-12">
					<label for="validationCustom03" class="form-label">Password:
					</label> <input type="password" class="form-control"
						id="validationCustom03" name="psw" required maxlength="8">
					<div class="invalid-feedback">Please provide your password</div>
				</div>
				<div class="col-12 text-danger error-message" style="display: none;">
					<%-- Check if error message exists in request and display it --%>
					<%
